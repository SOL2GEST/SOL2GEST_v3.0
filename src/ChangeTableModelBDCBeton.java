 ...
 * @author bsabaron
 */
public class ChangeTableModelBDCBeton implements TableModelListener {
    
    public static JTable tab;
    public static JTextField montantTot;

    public ChangeTableModelBDCBeton(JTable tab, JTextField montantTot) {
        super();
        ChangeTableModelBDCBeton.tab=tab;
        ChangeTableModelBDCBeton.montantTot=montantTot;
    }
