 ...
 * @author bsabaron
 */
public class ChangeTableModelBDCTS implements TableModelListener {
    
    public static JTable tab;
    public static JTextField montantTot;

    public ChangeTableModelBDCTS(JTable tab, JTextField montantTot) {
        super();
        ChangeTableModelBDCTS.tab=tab;
        ChangeTableModelBDCTS.montantTot=montantTot;
    }
